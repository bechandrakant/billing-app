        ...
        <div className="col-md-12">
          <div className="card" id="invoice">
            <div className="card-header bg-transparent header-elements-inline">
              <h6 className="card-title text-primary">{sellerData.name}</h6>
            </div>
                ...
                <div className="col-sm-6">
                  <div className="mb-4 pull-left">
                    <ul className="list list-unstyled mb-0 text-left">
                      <li>{sellerData.address.address}</li>
                      <li>{sellerData.address.city}</li>
                      <li>{sellerData.contactDetails[0]}</li>
                    </ul>
                  </div>
                </div>
                <div className="col-sm-6">
            ...
            <div className="table-responsive">
              <table className="table table-lg">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <h6 className="mb-0">Template for desnging the arts</h6>
                      <span className="text-muted">
                  ...
                  <tr>
                    <td>
                      <h6 className="mb-0">Technical support international</h6>
                      <span className="text-muted">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor
                      </span>
            ...
            <div className="card-footer">
              <span className="text-muted">
                ...
                nulla pariatur.Duis aute irure dolor in reprehenderit
              </span>
            </div>
          </div>
        </div>
