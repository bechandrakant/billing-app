export const gstStateData = [
  ...
  { stateName: "CHATTISGARH", stateCode: "22" },
  { stateName: "MADHYA PRADESH", stateCode: "23" },
  { stateName: "GUJRAT", stateCode: "24" },
  { stateName: "DADRA NAGAR HAVELI DAMAN DIU", stateCode: "25" },
  { stateName: "MAHARASHTRA", stateCode: "26" },
  // { stateName: "", stateCode: "27" },
  { stateName: "KARNATKA", stateCode: "28" },
  { stateName: "KARNATAKA", stateCode: "29" },
  { stateName: "GOA", stateCode: "30" },
  { stateName: "LAKSHWADEEP", stateCode: "31" },
